...
export function PizzaItemsManager({ restaurant: initialRestaurant }: { restaurant: Restaurant }) {
  ...
  function openCreate() {
    ...
    setItem({ name: "", price: "", discountPercent: "0", courseId: restaurant.courses[0]?.id ?? "" });
  ...
  return (
    <div className="space-y-5">
      ...
      <SectionCard title="Inventory" description="Course, price, discount, stock status, and item actions." bodyClassName="p-0">
